...
class Category(BaseModel): #RESPONSE MODEL 
    """
    ...
    model_config = ConfigDict(from_attributes=True) # позволяет преобразовывать данные из базы в Pydantic-модели.


class ProductCreate(BaseModel):#CREATE MODEL
    """
...
class Product(BaseModel): #RESPONSE MODEL
    """
